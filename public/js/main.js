...
events.forEach(event => {
  ...
  eventButton.addEventListener('click', () => {
    ...
    urlSearchParams.append('title', event.title);
    urlSearchParams.append('description', event.description);
    urlSearchParams.append('location', event.location);
    urlSearchParams.append('date', event.date);
    urlSearchParams.append('time', event.time);
    urlSearchParams.append('price', event.price);
    urlSearchParams.append('website', event.websiteLink);
    urlSearchParams.append('instagram', event.instagramLink);
    urlSearchParams.append('speaker', event.speakerName);

    window.location.href = `event.html?${urlSearchParams.toString()}`;
  });
